...
const ClientLogo1 = (props: SVGProps<SVGSVGElement>) => (
...
const ClientLogo2 = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 120 30" fill="currentColor" {...props}>
...
const ClientLogo3 = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 120 30" fill="currentColor" {...props}>
...
const ClientLogo4 = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 120 30" fill="currentColor" {...props}>
...
const ClientLogo5 = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 120 30" fill="currentColor" {...props}>
      <path d="M15 15 0 3v24l15-12zM30 3h3v24h-3V3z M45 3h3L60 15 48 27h-3l12-12L45 3z M75 15a12 12 0 1 1 0 .1z M90 3h3v24h-3V3z M105 3h3v24h-3V3z"/>
    </svg>
);
