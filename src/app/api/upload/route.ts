...
export async function POST(req: NextRequest) {
  try {
    ...
    const doc = await FirestoreService.getByConditions<RepositoryDoc>("Repositories",[
      {
    ...
    for (const entry of zipEntries) {
      ...
      try {
        ...
        const fileUrl = await FirestoreService.uploadFile(fileContent, name, filePath);
    ...
    await FirestoreService.setDoc<RepositoryDoc>("Repositories", name, {
      repoName : name ,
      title : title ,
